...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _langSets = __webpack_require__(174);
	...
	exports.default = {
	  ...
	  computed: {
	    ...
	    text: function text() {
	      return _langSets2.default[this.locale];
	    }
	  },
	  methods: {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	  ...
	  }, [_vm._t("header-left"), _vm._v(" "), _c('button', {
	    staticClass: "prev-month btn btn-default",
	    on: {
	      "click": function($event) {
	    ...
	    class: _vm.leftBtnIcon
	  })]), _vm._v(" "), _c('button', {
	    staticClass: "next-month btn btn-default",
	    on: {
	      "click": function($event) {
	        $event.stopPropagation();
	        _vm.goNext($event)
	    ...
	    class: _vm.rightBtnIcon
	  })]), _vm._v(" "), _c('button', {
	    staticClass: "today btn btn-default"
	  }, [_vm._v(_vm._s(_vm.text.today))])], 2), _vm._v(" "), _c('div', {
